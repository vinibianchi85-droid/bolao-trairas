...
function App() {
  ...
  async function signUp() {
    ...
    if (data.user) {
      ...
      setModo('login')
      setMsg('Cadastro criado! Agora entre usando e-mail e senha.')
    }
  }

    if (!username || username.length < 8) {
      return setMsg('Crie um usuário válido com letras, números, ponto, traço ou underline.')
    }
    ...
    if (data.user) {
      ...
      setUsuario(username)
      setModo('login')
      setMsg(`Cadastro criado! Entre usando o usuário: ${username}`)
    }
  }
  ...
  async function login() {
    ...
    if (!email || !senha) {
      return setMsg('Informe e-mail e senha.')
    }
    ...
    return <main className="page login">
      ...
      <section className="card form">
        ...
        {modo === 'cadastro' && <>
          ...
          <p className="loginHint">Depois do cadastro, entre usando seu e-mail e senha.</p>
        </>}
